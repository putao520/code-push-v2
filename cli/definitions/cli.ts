...
export interface IFreeCommand extends ICommand{
    appName: string;
    deploymentName: string;
    regionName: string;
}
...
export interface IGroupAddCommand extends ICommand {
    groupName: string;
    description: string;
    script: string
}

export interface IGroupListCommand extends ICommand {
    format: string;
}

export interface IGroupRemoveCommand extends ICommand {
    groupName: string;
}

export interface IGroupAttachCommand extends ICommand {
    groupName: string;
    deploymentKey: string;
}

export interface IGroupDetachCommand extends ICommand {
    groupName: string;
    deploymentKey: string;
}
